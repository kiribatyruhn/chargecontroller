...
public class GpioTest {
    ...
    public static void main(String[] args) throws InterruptedException, PlatformAlreadyAssignedException, IOException {
        ...
        while(!exit) {
            ...
            System.out.println(" ( I2C ) GPIO INPUTS");
    ...
    public static void gpioOutputsMenu(){
        ...
        System.out.println();
        System.out.println("----------------------------------------");
        System.out.println("GPIO OUTPUTS TEST: " + PlatformManager.getPlatform().name());
        System.out.println("----------------------------------------");

        switch(PlatformManager.getPlatform()){
            case RASPBERRYPI:{
                Pin pins[] = new Pin[]{RaspiPin.GPIO_25};
                Arrays.sort(pins);
