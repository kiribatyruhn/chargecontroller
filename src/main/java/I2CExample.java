...
public class I2CExample {
    ...
    // TSL2561 I2C address
    public static final int TSL2561_ADDR = 0x48; // address pin not connected (FLOATING)
    ...
    public static void main(String[] args) throws InterruptedException, PlatformAlreadyAssignedException, IOException, UnsupportedBusNumberException {
        ...
        System.out.println("instant Bus 1");
        ...
        System.out.println("connect to " + TSL2561_ADDR);
...
//        console.println("TSL2561 ID = " + String.format("0x%02x", response) + " (should be 0x50)");
        ...
        for (byte i = 0; i < 256; i++) {
            device.write(0x40, i);
            System.out.println("Write "+ i + " to 0x40");
            Thread.sleep(10000);
        }
